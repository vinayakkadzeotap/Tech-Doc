...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  { term: 'Ada', definition: "Zeotap's official AI copilot, embedded across the platform (Audience Builder, Data Catalogue, Journey Canvas). Uses RAG + Vertex AI LLMs for natural language segmentation and contextual AI assistance.", category: 'ai-ml' },
  { term: 'UCID', definition: "Unified Customer Identity — Zeotap's core identity concept. A single persistent ID that unifies all cross-device, cross-channel identifiers for one person.", category: 'identity' },
  { term: 'ID+', definition: "Zeotap's universal identity solution powered by ~50 billion deterministic IDs. Enables cross-device and cross-channel identity resolution at scale using Aerospike and Scylla.", category: 'identity' },
  { term: 'CDP', definition: 'Customer Data Platform — A system that creates a persistent, unified customer database accessible to other systems for marketing, analytics, and operations.', category: 'general' },
  ...
  { term: 'Customer 360', definition: 'A complete, unified view of a customer within the Protect module. Shows identity, attributes, events, audiences, and consent status in one place.', category: 'identity' },
  ...
  { term: 'Delta Lake', definition: 'An open-source storage layer on top of data lakes that provides ACID transactions, schema enforcement, and time-travel. Used by Zeotap for the Profile Store with 7 Maven modules.', category: 'infrastructure' },
  ...
  { term: 'Identity Graph', definition: 'A data structure that maps and links multiple identifiers (email, phone, device ID, cookie) belonging to the same person.', category: 'identity' },
  { term: 'MAID', definition: 'Mobile Advertising ID — A device-level identifier (IDFA on iOS, GAID on Android) used for mobile user identification and ad targeting.', category: 'identity' },
  ...
  { term: 'Vertex AI', definition: "Google Cloud's ML platform used by Zeotap for training and serving models including propensity scoring and Ada AI.", category: 'ai-ml' },
  { term: 'RAG', definition: 'Retrieval-Augmented Generation — An AI architecture where relevant context is retrieved from a knowledge base before generating a response. Powers Ada.', category: 'ai-ml' },
  ...
  { term: 'Journey Canvas', definition: "Zeotap's visual tool for building multi-step automated customer campaigns with triggers, conditions, and actions.", category: 'activation' },
  ...
  { term: 'GDPR', definition: "General Data Protection Regulation — EU regulation governing data privacy and protection that fundamentally shapes Zeotap's architecture.", category: 'privacy' },
  ...
  { term: 'DMP', definition: 'Data Management Platform — An older technology that relied on third-party cookies. CDPs like Zeotap are the modern replacement.', category: 'general' },
