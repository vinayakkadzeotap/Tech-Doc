...
const QUIZZES: QuizData[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'q2_2', text: 'What does Zoe (Zeotap\'s AI assistant) use to generate segments from natural language?', options: ['Rule templates only', 'RAG (Retrieval-Augmented Generation) + Vertex AI LLMs', 'Simple keyword matching', 'Pre-defined patterns'], correct: 1, explanation: 'Zoe uses RAG — retrieves schema context, then uses Vertex AI LLMs to translate natural language into segment rules.' },
  ...
  },
  {
    ...
    passScore: 70,
    questions: [
      { id: 'pm1', text: 'To create a new audience segment in Zeotap, you would use:', options: ['The Settings page', 'The Audience Builder', 'The API Console', 'The Data Sources page'], correct: 1, explanation: 'The Audience Builder is the primary tool for creating segments using rules, conditions, or natural language via Zoe.' },
      ...
      { id: 'pm5', text: 'Natural language segmentation in Zeotap is powered by:', options: ['Manual rule templates', 'Zoe AI assistant', 'External SQL queries', 'Spreadsheet imports'], correct: 1, explanation: 'Zoe uses AI to convert natural language queries like "Users who bought in the last 7 days" into structured segment rules.' },
    ],
  },
];
